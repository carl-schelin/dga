...
session_start();
#
#  Package: information.php
#  Version: 1.0.0
#  Author: Carl Schelin, Copyright 2013. All rights reserved.
#  Function: Show the information
#  Description: This lists the options available for logging in and out
...
# perhaps 'signup' logs the user in as a link.
  if (isset($_SESSION['username'])) {
    ...
    logaccess($_SESSION['username'], $package, "View information menu");
  ...
  <div id="contentwrapper">
    <div id="contentcolumn">
      <div class="innertube">
        ...
        <h1>Information</h1>
        <ul>
          <li><a href="<?php print $Siteroot; ?>/rules.php">Convention Rules</a></li>
          <li><a href="<?php print $Siteroot; ?>/contact.php">Contact Information</a></li>
          <li><a href="<?php print $Siteroot; ?>/mailinglist.php">Announcements Mailing List</a></li>
          <li><a href="<?php print $Siteroot; ?>/exhibitor.php">Exhibitor Info</a></li>
          <li><a href="<?php print $Siteroot; ?>/advertise.php">Advertiser</a></li>
        </ul>
      </div> 
    </div>  
  </div>
