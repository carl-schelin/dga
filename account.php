...
#  Function: Show the account menu
...
# perhaps 'signup' logs the user in as a link.
  if (isset($_SESSION['username'])) {
    ...
    logaccess($_SESSION['username'], $package, "View account menu");
...
<div id="main">
  <div id="contentwrapper">
    <div id="contentcolumn">
      <div class="innertube">
        <a href="/approved/<?php print $a_booklet['img_file']; ?>"><img src="/approved/<?php print $a_limage['img_file']; ?>" style="float: left;"></a>
        <h1>Account</h1>
        <ul>
<?php
  if (isset($_SESSION['username'])) {
...
?>
  ...
  <div id="rightcolumn">
    <div class="innertube">
      <img src="/approved/<?php print $a_rimage['img_file']; ?>">
    </div>
  </div>
</div>
